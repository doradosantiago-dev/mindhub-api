 ...
 * durante la revisión de un reporte en la plataforma.
 *
...
public class ReportReviewException extends RuntimeException {
     ...
     *
     * @param message descripción del motivo por el cual falló la revisión del
     *                reporte
     */
    public ReportReviewException(String message) {
        super(message);
    }
